...
namespace LR_Import
{
    public class ResourceVersionController : BaseDataManager
    {
        ...
        public string Create(ResourceVersion entity, ref string statusMessage)
        {
            ...
            {
                auditManager.LogMessage(LearningRegistry.reportId, LearningRegistry.fileName, "", "", ErrorType.Error, ErrorRouting.Technical, ex.ToString());

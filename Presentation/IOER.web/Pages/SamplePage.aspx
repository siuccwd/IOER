<%@ Page Title="Illinois Open Educational Resources - Sample Site Home Page" Language="C#" AutoEventWireup="true" CodeBehind="SamplePage.aspx.cs" Inherits="IOER.Pages.SamplePage" %>
...
<body class="page1">
    <form id="form1" runat="server" onsubmit="return false;">
      <div id="content">
        ...
        <div class="page" id="page2"><div class="pageContent"><iframe src="//apps.il-work-net.com/Calendar/Public/Events/CalendarWidget1.aspx?eventseparator=4AA394&fontFamily=Calibri,Arial,Helvetica,sans-serif"></iframe></div></div>
        ...
        <div class="page" id="page5"><div class="pageContent"><iframe src="/widgets/curriculum/?curriculum=2197&node=2197"></iframe></div></div>

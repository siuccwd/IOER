<%@ Page Title="Illinois Open Educational Resources - Organizations" Language="C#" MasterPageFile="~/Masters/Responsive2.Master" AutoEventWireup="true" CodeBehind="Organizations.aspx.cs" Inherits="IOER.Organizations.Organizations" %>

<%@ Register Src="~/Organizations/controls/OrganizationMgmt.ascx" TagPrefix="uc1" TagName="OrganizationMgmt" %>
                 ...
                 <asp:Panel ID="mbrDetailPanel"  Visible="true" runat="server">
                    ...
                    <div class="dataColumn">
                        <asp:RadioButtonList ID="rblMemberType" runat="server">
                            ...
                            <asp:ListItem Text="Add as Contractor/External"        Value="4"></asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                    ...
                    <div class="clearFloat"></div>
                            ...
                            <br />
                    <div class="clearFloat"></div>
                    <div class="labelColumn">History</div>
                    <div class="dataColumn"><asp:Label ID="lblHistory"   runat="server" ></asp:Label>
                    </div>
                    <div class="clearFloat"></div>
...
<asp:Panel ID="hiddenPanel" runat="server" Visible="false">
    <asp:Literal ID="formSecurityName" runat="server" Visible="false">Site.Admin.Org.Organizations</asp:Literal>

...
<style type="text/css">
  ...
  #communityPostMaker { max-width: 600px; margin: 5px auto -80px auto;  }
  #postBox { width: 100%; resize: none; height: 4em; }
  #mainReplyBox { text-align: right; }
  #btnPostMessage { width: 75px; }
  #communityHeader { min-height: 160px; position: relative; margin: -10px -5px 100px -5px; padding: 10px; background-color: #4AA394; background: linear-gradient(#4AA394, #5AB3A4); background: -webkit-linear-gradient(#4AA394, #5AB3A4); }
  ...
  #communityAvatar { width: 150px; height: 150px; position: absolute; top: 5px; left: 5px; border-radius: 5px; background: url('') center center #999; border: 1px solid #333; transition: width 0.8s, left 0.8s, height 0.8s; -webkit-transition: width 0.8s, left 0.8s, height 0.8s; }
  ...
  .dateSeparator { text-align: center; padding: 2px 5px; max-width: 200px; margin-top: 30px; font-weight: bold; }
  ...
  .replyBox { position: relative; text-align: right; }
  ...
  @media screen and (min-width: 980px) {
    #communityHeader { padding-left: 60px; margin-left: -55px; }
    #communityAvatar { left: 55px; }
  }
  @media screen and (max-width: 950px) {
    #communityHeader { margin-bottom: 150px; }
    #communityHeader.login { margin-bottom: 80px; }
    #communityPostMaker { margin: 75px auto -130px auto; }
  }
...
<div id="templates" style="display:none;">
  <div id="template_posting">
    <div class="posting grayBox" data-postingID="{postingID}">
      ...
      <h2 class="name">{name}</h2><span class="date">{date} {deleteLink}</span>
      <p>{text}</p>
      <div class="replyBox" data-postingID="{postingID}"><a href="#" class="textLink" onclick="openReplyBox({postingID}); return false;">Reply</a></div>
    </div>

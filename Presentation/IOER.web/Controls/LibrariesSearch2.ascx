<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LibrariesSearch2.ascx.cs" Inherits="ILPathways.Controls.LibrariesSearch2" %>
...
<div id="content">
  ...
  <div id="templates" style="display:none;">
    ...
    <div id="template_rb">
      <label for="{id}"><input type="radio" id="{id}" name="{name}" value="{value}" data-listID="{listID}" data-itemID="{itemID}" /> {text}</label>
    </div>
    <div id="template_searchResult">
      <div class="result" data-libraryID="{libraryID}">
        ...
        <a class="stretchyThumb" href="{libraryURL}"><img {iconSRC} /></a>
        <div class="data">

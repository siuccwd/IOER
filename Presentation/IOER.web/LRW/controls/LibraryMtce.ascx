<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LibraryMtce.ascx.cs" Inherits="ILPathways.LRW.controls.LibraryMtce" %>
...
<div id="containerDetails">
	...
	<h2 class="isleH2"><asp:label ID="libraryName" runat="server">Library Management</asp:label></h2>
...
<asp:Literal ID="txtFormSecurityName" runat="server" Visible="false">ILPathways.LRW.controls.LibraryMtce</asp:Literal>

<!-- control variables -->
<asp:Literal ID="txtDefaultLibraryTypeId" runat="server" Visible="false">2</asp:Literal>
<asp:Literal ID="showingImagePath" runat="server" Visible="false">no</asp:Literal>
<!-- message variables -->
<asp:label ID="formMessage1" runat="server" Visible="false">Some form message</asp:label>

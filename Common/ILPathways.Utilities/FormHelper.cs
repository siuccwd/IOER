...
namespace ILPathways.Utilities
{
	...
	public class FormHelper
	{
		...
		public static void SetApplicationMessage( ResourceManager rm, string resString, PlaceHolder msgPlaceholder )
		{
			string msgString = rm.GetString( resString );
		...
		public static void SetApplicationMessage( string msgString, PlaceHolder msgPlaceholder )
		{
			...
			WBE.FormMessage formMessage = new WBE.FormMessage();
		...
		public static void SetApplicationMessage( ResourceManager rm, string resString, bool showPopup )
		{
		...
		public static void SetApplicationInfoMessage( ResourceManager rm, string resString, bool showPopup )
		{
		...
		public static void HandleAppMessage( string usingFormMessage, HtmlGenericControl container )
		{
			...
			{
				WBE.FormMessage message = new WBE.FormMessage();
				message = ( WBE.FormMessage ) HttpContext.Current.Session[ "FormMessage" ];
				if ( message != null )
				{
